...
_NS_INLINE void NS::Window::setContentView( const NS::View* pContentView )
{
	Object::sendMessage< void >( this, _APPKIT_PRIVATE_SEL( setContentView_ ), pContentView );
	    ...
	    // Get the contentView
   // NS::View* contentView = Object::sendMessage<NS::View*>(this, sel_registerName("contentView"));

	//NS::Object* layer = Object::sendMessage<NS::Object*>(pContentView, sel_registerName("layer"));

    // Set the layer
  //  Object::sendMessage<void>(contentView, sel_registerName("setLayer"), layer);

    // Enable wantsLayer = YES
  //  Object::sendMessage<void>(contentView, sel_registerName("setWantsLayer"), YES);
